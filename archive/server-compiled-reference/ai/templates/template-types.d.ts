...
export type DocumentPlatform = 'jira' | 'confluence' | 'wiki' | 'figma' | 'github' | 'linear' | 'notion' | 'azure-devops' | 'trello' | 'asana';
export type DocumentType = 'component' | 'feature' | 'bug' | 'epic' | 'documentation' | 'api-spec' | 'design-handoff' | 'pr-template' | 'issue-template';
...
export type TemplateSectionType = 'title' | 'summary' | 'requirements' | 'design_context' | 'acceptance_criteria' | 'technical_implementation' | 'testing_strategy' | 'design_system_integration' | 'complexity_analysis' | 'subtasks' | 'ai_assistant_integration' | 'related_work' | 'dependencies' | 'risk_factors' | 'timeline' | 'resources';
export type ComplexityLevel = 'simple' | 'medium' | 'complex';
export type Priority = 'low' | 'medium' | 'high' | 'critical';
export type TestingFramework = 'jest-rtl' | 'cypress' | 'playwright' | 'vitest' | 'mocha-chai' | 'jasmine' | 'karma';
export type AccessibilityLevel = 'basic' | 'wcag-aa' | 'wcag-aaa' | 'enterprise' | 'government';
export type DocumentationFormat = 'markdown' | 'confluence' | 'notion' | 'jsdoc' | 'storybook' | 'gitbook';
export type CodeStyle = 'airbnb' | 'standard' | 'prettier' | 'google' | 'custom';
export type ReviewProcess = 'standard' | 'design-review' | 'security-review' | 'accessibility-review' | 'performance-review';
export type DeploymentProcess = 'ci-cd' | 'manual' | 'automated' | 'staged' | 'blue-green';
