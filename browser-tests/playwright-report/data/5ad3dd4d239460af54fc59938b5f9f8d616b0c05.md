...
- generic [ref=e2]:
  ...
  - generic [ref=e11]:
    ...
    - generic [ref=e33]:
      ...
      - textbox "e.g., I need a React app with TypeScript, using Material-UI for styling, Jest for testing, and I want to deploy on Vercel..." [ref=e38]
      - generic [ref=e39]:
    ...
    - generic [ref=e55]:
      ...
      - combobox "Document Type" [ref=e57]:
        ...
        - option "Agent Task"
    - button "🚀 Generate Enhanced Document" [ref=e58] [cursor=pointer]
```