...
- generic [ref=e2]:
  ...
  - generic [ref=e11]:
    ...
    - generic [ref=e33]:
      ...
      - textbox "e.g., I need a React app with TypeScript, using Material-UI for styling, Jest for testing, and I want to deploy on Vercel..." [ref=e38]: Vue 3 with Composition API and Pinia
      - generic [ref=e39]:
        ...
        - generic [ref=e41]:
          ...
          - generic [ref=e47] [cursor=pointer]: Figma + Design System
      - generic [ref=e48]:
        - button "🧠 Parse Tech Stack" [ref=e49] [cursor=pointer]
        - generic [ref=e50]:
          - generic [ref=e51]: "Confidence:"
          - generic [ref=e54]: 0%
    - generic [ref=e55]:
      - generic [ref=e56]: Document Type
      - combobox "Document Type" [ref=e57]:
    ...
    - generic [ref=e58]:
      - generic [ref=e59]:
        ...
        - generic [ref=e61]: 80%
      - generic [ref=e63] [cursor=pointer]: Vue
    - button "Generating..." [disabled] [ref=e64]: Generating...
    - generic [ref=e66]:
      - generic [ref=e67]: Generated Content
      - textbox [ref=e68]: Generating enhanced content...
      - button "📋 Copy to Clipboard" [ref=e69] [cursor=pointer]
```